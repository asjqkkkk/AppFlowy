...
impl From<AppResponseError> for FlowyError {
  fn from(error: AppResponseError) -> Self {
    let code = match error.code {
      ...
      AppErrorCode::FeatureNotAvailable => ErrorCode::FeatureNotAvailable,
      ...
      AppErrorCode::ImportError => ErrorCode::AppFlowyDataFolderImportError,
      AppErrorCode::ExportError => ErrorCode::Internal,
      AppErrorCode::UploadFileNotFound => ErrorCode::RecordNotFound,
      AppErrorCode::UploadFileExpired => ErrorCode::Internal,
      AppErrorCode::UploadFileTooLarge => ErrorCode::SingleUploadLimitExceeded,
      AppErrorCode::UpgradeRequired => ErrorCode::LimitedByWorkspacePlan,
      AppErrorCode::UnzipError => ErrorCode::UnsupportedFileFormat,
      AppErrorCode::CannotOpenWorkspace => ErrorCode::WorkspaceInitializeError,
      AppErrorCode::StreamGroupNotExist => ErrorCode::RecordNotFound,
      AppErrorCode::S3ServiceUnavailable => ErrorCode::NetworkError,
      AppErrorCode::ImportCollabError => ErrorCode::AppFlowyDataFolderImportError,
      AppErrorCode::RealtimeProtocolError => ErrorCode::NetworkError,
      AppErrorCode::CollabAwarenessError => ErrorCode::DataSyncRequired,
      AppErrorCode::RealtimeDecodingError => ErrorCode::Serde,
      AppErrorCode::UnexpectedRealtimeData => ErrorCode::InvalidParams,
      AppErrorCode::ExpectInitSync => ErrorCode::DataSyncRequired,
      AppErrorCode::CollabError => ErrorCode::Conflict,
      AppErrorCode::NotEnoughPermissionToWrite => ErrorCode::NotEnoughPermissions,
      AppErrorCode::NotEnoughPermissionToRead => ErrorCode::NotEnoughPermissions,
      AppErrorCode::RealtimeUserNotFound => ErrorCode::RecordNotFound,
      AppErrorCode::GroupNotFound => ErrorCode::RecordNotFound,
      AppErrorCode::CreateGroupWorkspaceIdMismatch => ErrorCode::InvalidParams,
      AppErrorCode::CreateGroupCannotGetCollabData => ErrorCode::CollabDataNotSync,
      AppErrorCode::NoRequiredCollabData => ErrorCode::CollabDataNotSync,
      AppErrorCode::TooManyRealtimeMessages => ErrorCode::TooManyRequests,
      AppErrorCode::LockTimeout => ErrorCode::RequestTimeout,
      AppErrorCode::CollabStreamError => ErrorCode::NetworkError,
      AppErrorCode::CannotCreateGroup => ErrorCode::Internal,
      AppErrorCode::BincodeCollabError => ErrorCode::Serde,
      AppErrorCode::CreateSnapshotFailed => ErrorCode::Internal,
      AppErrorCode::GetLatestSnapshotFailed => ErrorCode::RecordNotFound,
      AppErrorCode::CollabSchemaError => ErrorCode::InvalidParams,
      AppErrorCode::LeaseError => ErrorCode::Internal,
      AppErrorCode::SendWSMessageFailed => ErrorCode::NetworkError,
      AppErrorCode::IndexerStreamGroupNotExist => ErrorCode::RecordNotFound,
      AppErrorCode::LicenseLimitHit => ErrorCode::LicenseReachLimit,
    };
